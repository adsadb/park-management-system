<template>
    <div>
        ...
        <div>
            <audio id="myAuto" src="/xjtu/static/audio/attention_region.mp3" controls v-show="false"></audio>
            <Row :gutter="20">
                <Col span="17">
                    ...
                    <div style="position:absolute; height:553px; overflow:auto;width:100%">
                        <div v-for="(item,index) in data" :key="index">
                            <Card dis-hover class="card" > 
                                ...
                                <div class="p-box"><Icon type="md-locate"/><p style="display:inline">事件:区域入侵</p></div>   
                            </Card>
                        </div>
                    </div>
                </Col>
